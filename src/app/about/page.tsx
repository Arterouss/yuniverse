      ...
      <section className="pt-8 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="flex flex-wrap items-center gap-4 pt-2">
            <Link
              href="/contact"
              className="px-8 py-4 rounded-2xl bg-gradient-to-r from-rose-400 via-red-500 to-pink-600 text-[#0B0608] font-bold text-sm tracking-wider uppercase shadow-[0_0_25px_rgba(244,63,94,0.5)] hover:shadow-[0_0_40px_rgba(244,63,94,0.8)] hover:scale-105 transition-all flex items-center gap-2"
            >
            ...
            <a
              ...
              className="px-8 py-4 rounded-2xl cosmic-glass border border-rose-400/30 text-ice-white hover:text-rose-300 font-semibold text-sm tracking-wider uppercase hover:border-rose-400 transition-all flex items-center gap-2"
            >
        ...
        <div className="lg:col-span-5 flex justify-center">
          <div className="relative w-80 h-80 sm:w-96 sm:h-96 rounded-full cosmic-glass border-2 border-rose-400/40 flex items-center justify-center shadow-[0_0_60px_rgba(244,63,94,0.3)] animate-float-slow">
            <div className="absolute inset-4 rounded-full bg-gradient-to-br from-rose-400/20 via-red-500/10 to-pink-600/20 blur-xl pointer-events-none" />
            <div className="text-center space-y-3 z-10 p-8">
              <div className="w-20 h-20 mx-auto rounded-3xl bg-[#0B0608] border border-rose-400/40 flex items-center justify-center shadow-[0_0_25px_rgba(244,63,94,0.4)]">
              ...
              <div className="pt-2 flex justify-center gap-2 font-mono text-[11px] text-slate-400">
                <span className="px-2.5 py-1 rounded-md bg-white/[0.04] border border-rose-400/20">4+ Yrs Exp</span>
                <span className="px-2.5 py-1 rounded-md bg-white/[0.04] border border-rose-400/20">100% Remote</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {BIO_PHILOSOPHY.philosophy.map((item, idx) => (
            <div
              key={idx}
              className="cosmic-glass rounded-3xl p-8 border border-rose-400/25 hover:border-rose-400/60 shadow-[0_4px_30px_rgba(244,63,94,0.08)] hover:shadow-[0_10px_40px_rgba(244,63,94,0.2)] transition-all duration-300 space-y-4 flex flex-col justify-between"
            >
              <div className="space-y-3">
                <div className="w-12 h-12 rounded-2xl bg-rose-500/15 border border-rose-400/30 flex items-center justify-center text-rose-400 shadow-[0_0_15px_rgba(244,63,94,0.2)]">
